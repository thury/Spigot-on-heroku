...
heroku buildpacks:add https://github.com/thury/Spigot-on-heroku
heroku ps:exec
...
By default, dropbox sync will automatic backup your data every 5 minutes.
...
Example: world_flat world world_nether world_the_end
